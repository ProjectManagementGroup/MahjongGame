...
public class RSAService {
    ...
    private static final Logger LOGGER = Logger.getLogger(RSAService.class);
    ...
    public KeyPair generateKeyForClient() throws Exception {
        KeyPairGenerator keyPairGenForClient = KeyPairGenerator.getInstance("RSA", DEFAULT_PROVIDER);
        return keyPairGenForClient.generateKeyPair();
    }
    ...
    public static String[] decryptUsernameAndPwd(String key) {
        ...
        key = RSAService.decryptStringByJs(key);
    ...
    //public static void main(String[] args) throws Exception {
        //String encryptText = encryptString("a");
        //System.out.println(encryptText);
        //System.out.println(decryptString(encryptText));
        //decryptUsernameAndPwd("");
    //}
}
