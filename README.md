...
服务器推送房间内所有成员的信息 |  这个接口用于页面的时候，需要展示房间内所有玩家的信息：username、是否准备和积分 | 无需请求自动推送 |</small>{"ok": true, "message": "room information", "object": {"all":[{"username":"000","point":0,"ready":false,"index":0},{"username":"111","point":111,"ready":false,"index":1},{"number":2,"type":"dragon"},{"number":5,"type":"myriad"},{"number":2,"type":"wind"},{"username":"222","point":222,"ready":false,"index":2}]}}   | | list里面是一个用户信息的数组；注意游戏开始后就会自动立即为第一个人发牌，所以前端的webSocket要随时准备接收消息 
创建好友房间 | 必须并同时邀请三个好友，暂时设定为通过输入username进行邀请，如果输入错误或者好友不在线，那么创建房间失败；创建成功后，房主进入一个空房间等待其他三位好友 | `invite`<font color=red>\|</font>friend1<font color=red>\|</font>friend2<font color=red>\|</font>friend3 | 对于被邀请玩家收到的信息{"ok": true, "message": "invitation", "object": {"banker":"zyw","username1":"111","username2":"222","username3":"333","room":"20171212154942"}}  对于房主收到的信息{"ok": true, "message": "invite success", "object": “20171212154942’} | | friend1、 friend2、 friend3指的是三位好友的用户名；前台通过message的invitation判断是不是一个邀请；object里面存放的是房间号
...
用户申请好友 | 把对方的用户名发送给服务器 | friendInvitation<font color=red>\|</font>zyw | 给被申请者发的消息{"ok": true, "message": "friendInvitation", "object": anyi} 不给申请者发消息了 | | anyi是申请者，zyw会收到一条anyi申请加好友的消息|
接受好友申请| | friendAccept<font color=red>\|</font>anyi | 对于申请者anyi来说，会收到{"ok": true, "message": "friendAccept", "object": zyw} 对于被申请者zyw来说，会收到{"ok": true, "message": "friendAccept", "object": anyi} | | 申请者anyi收到了zyw接受了自己发出的好友申请的消息，被申请者zyw同意了anyi的好友申请|
...
游戏开始发牌 | 庄家index=0并且初始有14张牌 | 推送，紧跟着上面的推送 | {"ok": true, "message": "game start allocate", "object": {"ownIndex":0,"ownTiles":[{"number":1,"type":"wind"},{"number":5,"type":"bamboo"},{"number":3,"type":"dragon"}]}} | | 
发牌 |***不需要用户请求***，因为用户不知道自己的顺序，这个功能由服务器推送| 无 | 对被发牌玩家{"ok": true, "message": "get tile", "object": {"number":6,"type":"bamboo","typeid":0}} 对其他玩家：{"ok": true, "message": "allocate tile", "object": {"name":"zyw","gameid":2}} | {"ok": false, "message": "错误信息", "object": null} | message=getTile是回复类型由前台进行判断；object里面放的是麻将牌的名称；对其他玩家广播给zyw发牌了
出牌 | 前台记得要给玩家出牌进行计时 | `out`<font color=red>\|</font>tile | 对于出牌玩家的回复消息{"ok": true, "message": "out success", "object": null}    对于其余玩家的广播消息{"ok": false, "message": "other out", "object": {"username":"zyw","index":2,"tile":{"number":6,"type":"bamboo"}}}   | | 对其他玩家要广播是谁出了什么牌
