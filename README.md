...
服务器推送房间内所有成员的信息 |  这个接口用于页面的时候，需要展示房间内所有玩家的信息：username、是否准备和积分 | 无需请求自动推送 |</small>{"ok": true, "message": "room information", "object": {"others":[{"username":"000","point":0,"ready":false,"index":0,"thrownTiles":[{"number":1,"type":"wind"},{"number":5,"type":"bamboo"},{"number":3,"type":"dragon"}]},{"username":"111","point":111,"ready":false,"index":1,"thrownTiles":[{"number":2,"type":"bamboo"},{"number":2,"type":"dot"},{"number":1,"type":"dragon"}]},{"number":2,"type":"dragon"},{"number":5,"type":"myriad"},{"number":2,"type":"wind"},{"username":"222","point":222,"ready":false,"index":2,"thrownTiles":[]}],"me":{"username":"333","point":333,"ready":true,"index":3,"ownTiles":[{"number":8,"type":"dot"},{"number":4,"type":"bamboo"},{"number":6,"type":"bamboo"}],"thrownTiles":[{"number":8,"type":"dot"},{"number":4,"type":"bamboo"},{"number":6,"type":"bamboo"}]},"restTiles":52}}    | | list里面是一个用户信息的数组；注意游戏开始后就会自动立即为第一个人发牌，所以前端的webSocket要随时准备接收消息 
...
游戏开始发牌 | 庄家index=0并且初始有14张牌 | 推送，紧跟着上面的推送 | {"ok": true, "message": "game start allocate", "object": {"own-index":0,"own-tiles":[{"number":1,"type":"wind"},{"number":5,"type":"bamboo"},{"number":3,"type":"dragon"}]}} | | 
